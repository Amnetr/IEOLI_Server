...
<div class="row" style="margin-top: -20px">
  ...
  <div class="middle col-md-8" style="background-color: white;">
    <div >
      <iframe id="external-frame" style="width: 100%;height:1000px; margin-top: 40px" src="jsp/selectType.jsp" frameborder="0" scrolling="no" onload="setIframeHeight(this)"></iframe>
    </div>
  </div>
  <div class="col-md-2"></div>
</div>
