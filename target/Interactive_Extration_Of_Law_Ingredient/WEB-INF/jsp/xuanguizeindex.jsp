      ...
      <ul class="layui-nav admin-header-item">
        <li class="layui-nav-item"> <a href="javascript:;" class="admin-header-user"> <img src="images/0.jpg" /> <span>beginner</span> </a>
          <dl class="layui-nav-child">
            ...
            <dd> <a href="login.jsp"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a> </dd>
          </dl>
        </li>
      </ul>
...
<div class="row" style="margin-top: -20px">
  ...
  <div class="middle col-md-8" style="background-color: white;">
    <div >
      <iframe id="external-frame" style="width: 100%;height:1000px; margin-top: 40px" src="page?path=task" frameborder="0" scrolling="no" onload="setIframeHeight(this)"></iframe>
    </div>
  </div>
  <div class="col-md-2"></div>
</div>
