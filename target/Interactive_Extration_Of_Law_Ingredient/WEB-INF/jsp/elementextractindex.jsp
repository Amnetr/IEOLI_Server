  ...
  <div class="layui-header header header-demo">
    <div class="layui-main">
      ...
      <ul class="layui-nav admin-header-item-mobile">
        <li class="layui-nav-item"> <a href="page?path=index"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a> </li>
      </ul>
    </div>
  </div>
...
<div class="row" style="margin-top: -20px">
  ...
  <div class="middle col-md-8" style="background-color: white;">
    <div >
      <iframe id="external-frame" style="width: 100%;height:1000px; margin-top: 40px" src="elementextract.jsp" frameborder="0" scrolling="no" onload="setIframeHeight(this)"></iframe>
    </div>
  </div>
  <div class="col-md-2"></div>
</div>
